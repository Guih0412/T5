...
CREATE TABLE `Cliente` (
    ...
    `rgEmissao` DATETIME(3) NOT NULL,
    `cpf` VARCHAR(191) NOT NULL,
    `cpfEmissao` DATETIME(3) NOT NULL,
...
-- AddForeignKey
ALTER TABLE `Consumo` ADD CONSTRAINT `Consumo_petId_fkey` FOREIGN KEY (`petId`) REFERENCES `Pet`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
